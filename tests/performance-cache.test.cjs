...
function load() {
  ...
  const sandbox={root:{LGXMBPS3BackgroundClock:clock},Renderer:function(){},RETAINED_DAY_NIGHT:{},IDLE_BRIGHTNESS:{background:1,wave:1,particles:1},Date,Float32Array};
