...
(async()=>{
 ...
 await menu.category(page,'settings');await page.keyboard.press('Enter');assert.equal((await page.evaluate(()=>C5App.getState())).modal,'appearance');
 ...
 await menu.category(page,'settings');await page.keyboard.press('ArrowDown');await page.keyboard.press('Enter');
