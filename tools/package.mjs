...
try {
  ...
  for (const relativeName of [appinfo.main, appinfo.icon, 'background-music.js', 'ps3-particles.js', 'category-transition.js', 'licenses/LICENSE', 'licenses/THIRD-PARTY-NOTICES.md', 'licenses/UPSTREAM-original.frag', 'licenses/UPSTREAM-config.json', 'licenses/PS3-XMB-MIT.txt', 'licenses/THREE-FXAA-MIT.txt']) {
